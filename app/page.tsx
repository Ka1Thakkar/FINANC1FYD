  ...
  return (
    <main className=" flex flex-col items-center justify-start min-h-screen">
      ...
      <div className="relative w-[100vw]">
        ...
        <video src="/carsquad.mp4" autoPlay loop muted playsInline className="w-[100vw] object-cover h-[700px]"></video>
      </div>
      <div className="w-full flex-col flex items-center justify-center p-10 bg-black gap-5">
        ...
        <button className="bg-red-500 text-white text-lg px-5 py-2 rounded-md">
